 ...
 * @author oscar
 */
public class Reporte3G extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Reporte3G</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Reporte3G at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=Transacciones.pdf");
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/VerTransaccionesSumadas.jrxml"));
