 ...
 * @author oscar
 */
public class Reporte4L extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Reporte4L</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Reporte4L at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=SolicitudesRealizadas.pdf");
            ...
            File file = new File(request.getServletContext().getRealPath("/resources/SolicitudesRealizadas.jrxml"));
