<%-- 
    Document   : transacciones_cajero
    Created on : 2/11/2020, 18:08:20
    Author     : oscar
--%>
...
<html>
    <head>
        ...
        <title>Cajeros con mas transacciones</title>
    </head>
    <body>
        ...
        <%
            ArrayList<Transaccion> lista = (ArrayList<Transaccion>) request.getSession().getAttribute("transacciones_cajero");
        %> 
        ...
        <div style="width: 1000px; border: 1px solid black" class="container h-100">
            <h1>Cajeros que mas transacciones han realizado</h1>
            <table class="table">
                <thead>
                    <tr>
