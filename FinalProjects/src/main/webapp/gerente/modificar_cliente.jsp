<%-- 
    ...
    Created on : 27/10/2020, 22:57:51
    Author     : oscar19
--%>
        ...
        <div style="width: 1000px; border: 1px solid black; padding: 50px" class="container h-100">
            <form action ="FuncionesGerente" method = "POST" class="form-group">
                ...
                <div class="form-group">
                    <input type = "hidden" name = "codigo" value="${modCliente.getCodigo()}" class="form-control">
                </div>
                <div class="form-group">
                    <label>Nombre</label>
                    <input type = "text" name = "nom" value="${modCliente.getNombre()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>DPI</label>
                    <input type = "text" name = "dpi" value="${modCliente.getDpi()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>Fecha de Nacimiento</label>
                    <input type = "date" name = "fechaN" value="${modCliente.getNacimiento()}" class="form-control">
                </div>
                <div class="form-group">
                    <label>Direccion</label>
                    <input type = "text" name = "dir" value="${modCliente.getDireccion()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>Sexo</label>
                ...
                <div class="form-group">
                    <input type="submit" name ="accion" value="Modificar Cliente" class="btn btn-primary">
                    <input type="submit" name ="accion" value="Volver a los clientes" class="btn btn-primary">
                </div>
            </form>
            <button class="btn btn-primary" onclick="modCliente()">Cambiar Contraseña</button>
        </div>   
        <div hidden id ="divCliente" style="width: 1000px; border: 1px solid black; padding: 50px" class="container h-100">
            <form action ="FuncionesGerente" method = "POST" class="form-group">
                <h3>Modificar contraseña</h3>
                <div class="form-group">
                    <input type = "hidden" name = "codigoCliente" value="${modCliente.getCodigo()}" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="submit" name ="accion" value="Cambio" class="btn btn-primary">
                </div>
            </form>
        </div> 
    </body>
