    ...
    <body>
        <nav class="navbar bg-info">
            <div>
                ...
                <a class="nav-item active btn btn-outline-light" href="Controlador?accion=FuncionesC">Funciones</a>
        ...
        <div style="width: 1000px; border: 1px solid black; padding: 50px" class="container h-100">
            <form action ="FuncionesCajero" method = "POST" class="form-group">
                <h3>Depositos</h3>
                ...
                <div class="form-group">
                    <input type="submit" name ="accion" value="Realizar Deposito" class="btn btn-primary">
                </div>
            </form>
        </div>
    </body>
