<%-- 
    Document   : agregar_gerente
    Created on : 27/10/2020, 14:40:27
    Author     : oscar19
--%>
        ...
        <div style="width: 1000px; border: 1px solid black; padding: 50px" class="container h-100">
            <form action ="FuncionesGerente" method = "POST" class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type = "text" name = "codigoGerente" value="${newGerente.getCodigo()}" class="form-control">
                </div>
                <div class="form-group">
                    <label>Nombre</label>
                    <input type = "text" name = "nomGerente" value="${newGerente.getNombre()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>Turno</label>
                ...
                <div class="form-group">
                    <label>DPI</label>
                    <input type = "text" name = "dpiGerente" value="${newGerente.getDpi()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>Direccion</label>
                    <input type = "text" name = "direccionGerente" value="${newGerente.getDireccion()}" class="form-control">
                </div> 
                <div class="form-group">
                    <label>Sexo</label>
                    <select class="form-control" name ="sexoGerente">
                ...
                <div class="form-group">
                    ...
                    <input type = "text" name = "passGerente" value="${newGerente.getContraseña()}" class="form-control">
                </div> 
                <div class="form-group">
                    <input type="submit" name ="accion" value="Agregar Gerente" class="btn btn-primary">
