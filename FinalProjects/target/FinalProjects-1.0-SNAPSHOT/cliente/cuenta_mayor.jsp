<%-- 
    Document   : cuenta_mayor
    Created on : 6/11/2020, 17:43:13
    Author     : oscar
--%>
...
<html>
    ...
    <body>
        ...
        <div style="width: 1000px; border: 1px solid black; padding: 50px" class="container h-100">
            <form action ="ReportesCliente" method = "POST" class="form-group">
                ...
                <div class="form-group">
                    <input type="submit" name ="accion" value="Ver Cuenta" class="btn btn-primary">
                </div>
            </form>
        </div>
